...
def test__split_evaluator_extractor_iteration(eval_name, split_kwargs, create_split_logs_and_evaluator):
    ...
    actual_df = split_evaluator_extractor_iteration(
        split_value=1, result=logs, base_extractor=base_evaluator, **split_kwargs
...
def test__split_evaluator_extractor(eval_name, split_kwargs, create_split_logs_and_evaluator):
    ...
    actual_df = split_evaluator_extractor(
        logs, base_extractor=base_evaluator, split_values=[0, 1], **split_kwargs
    ).reset_index(drop=True)
...
def test_extract():
    ...
    base_evaluator = combined_evaluators(
        evaluators=[
    ...
    # Define extractors
    base_extractors = combined_evaluator_extractor(
        base_extractors=[
    ...
    splitter_extractor = split_evaluator_extractor(
        split_col="RAD", split_values=[4.0, 5.0, 24.0], base_extractor=base_extractors
    )
