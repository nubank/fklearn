import pandas as pd
from fklearn.causal.debias import debias_with_regression_formula, debias_with_regression
...
def test_debias_with_regression_formula():
    ...
    result2 = debias_with_regression_formula(df, "t", "y", "C(x)", suffix="_d", denoise=False)
...
def test_debias_with_regression():
    ...
    result2 = debias_with_regression(df, "t", "y", ["x"], suffix="_d", denoise=False)
