...
sample_data = pd.DataFrame(
    {
        "space": ["a", "a", "b", "b", "a", "c", "c"],
        "time": pd.to_datetime(
            ["2015-01-01", "2015-02-02", "2016-04-25", "2015-03-03", "2015-07-07", "2015-08-08", "2015-09-09"]
        ),
    }
)
...
def test_out_of_time_and_space_splitter():
    result, logs = out_of_time_and_space_splitter(
        sample_data, 2, "2015-05-05", time_column="time", space_column="space", holdout_gap=timedelta(days=31)
    )
...
def test_time_and_space_learning_curve_splitter():
    random_state = 21
    result, logs = time_and_space_learning_curve_splitter(
        sample_data,
        "2015-05-05",
        space_column="space",
        time_column="time",
...
def test_time_learning_curve_splitter():
    result, logs = time_learning_curve_splitter(
        sample_data, "2015-05-05", time_column="time", holdout_gap=timedelta(days=31), min_samples=0
    )
...
def test_reverse_time_learning_curve_splitter():
    result, logs = reverse_time_learning_curve_splitter(
        sample_data, time_column="time", training_time_limit="2015-05-05", holdout_gap=timedelta(days=31), min_samples=0
    )
...
def test_stability_curve_time_in_space_splitter():
    result, logs = stability_curve_time_in_space_splitter(
        sample_data,
        "2015-05-05",
        random_state=25,
        time_column="time",
...
def test_stability_curve_time_space_splitter():
    result, logs = stability_curve_time_space_splitter(
        sample_data,
        "2015-05-05",
        random_state=25,
        time_column="time",
